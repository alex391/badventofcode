...
// Be careful if the vec contains pointers, that the pointees are also freed
...
// element)
// Be careful if the items stored in the vec are pointers, that the pointee is freed
